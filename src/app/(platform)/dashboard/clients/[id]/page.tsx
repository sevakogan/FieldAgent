...
const ITEM = { id: '1', name: 'Sample clients', email: 'contact@example.com', phone: '(305) 555-0100', status: 'active', created: '2026-01-15' }
const HISTORY = [
...
export default function clientsDetailPage() {
  return (
    <div>
      <a href="/dashboard/clients" className="text-[#007AFF] text-sm mb-2 inline-block">← Back</a>
