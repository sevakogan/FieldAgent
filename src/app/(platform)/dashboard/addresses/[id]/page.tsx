...
const ITEM = { id: '1', name: 'Sample addresses', email: 'contact@example.com', phone: '(305) 555-0100', status: 'active', created: '2026-01-15' }
const HISTORY = [
...
export default function addressesDetailPage() {
  return (
    <div>
      <a href="/dashboard/addresses" className="text-[#007AFF] text-sm mb-2 inline-block">← Back</a>
