...
const ITEM = { id: '1', name: 'Sample invoices', email: 'contact@example.com', phone: '(305) 555-0100', status: 'active', created: '2026-01-15' }
const HISTORY = [
...
export default function invoicesDetailPage() {
  return (
    <div>
      <a href="/dashboard/invoices" className="text-[#007AFF] text-sm mb-2 inline-block">← Back</a>
