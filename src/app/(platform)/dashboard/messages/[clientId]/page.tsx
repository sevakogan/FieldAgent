...
const ITEM = { id: '1', name: 'Sample messages', email: 'contact@example.com', phone: '(305) 555-0100', status: 'active', created: '2026-01-15' }
const HISTORY = [
...
export default function messagesDetailPage() {
  return (
    <div>
      <a href="/dashboard/messages" className="text-[#007AFF] text-sm mb-2 inline-block">← Back</a>
